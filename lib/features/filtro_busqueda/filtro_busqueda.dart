    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ElevatedButton(
              onPressed: () { _toggleAlergeno(0); },
              style: ElevatedButton.styleFrom(
                backgroundColor: hasGluten ? Colors.lightBlueAccent : Colors.white,
                side: BorderSide(color: Colors.lightBlueAccent),
              ),
              child: const Text('Sin gluten'),
            ),
            const SizedBox(height: 16),
            ElevatedButton(
              onPressed: () { _toggleAlergeno(1); },
              style: ElevatedButton.styleFrom(
                backgroundColor: hasLactose ? Colors.lightBlueAccent : Colors.white,
                side: BorderSide(color: Colors.lightBlueAccent),
              ),
              child: const Text('Sin lactosa'),
            ),
            const SizedBox(height: 16),
            ElevatedButton(
              onPressed: () { _toggleAlergeno(2); },
              style: ElevatedButton.styleFrom(
                backgroundColor: hasNuts ? Colors.lightBlueAccent : Colors.white,
                side: BorderSide(color: Colors.lightBlueAccent),
              ),
              child: const Text('Sin frutos secos'),
            ),
          ],
        ),
      ),
