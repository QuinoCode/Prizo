...
class ListaCompraInterfaz2 extends StatefulWidget {
  final ListaCompra listaCompra;

  ListaCompraInterfaz2({super.key, required this.listaCompra});

  @override
  _ListaCompraInterfazState createState() => _ListaCompraInterfazState();
}

class _ListaCompraInterfazState extends State<ListaCompraInterfaz2> with WidgetsBindingObserver  {
