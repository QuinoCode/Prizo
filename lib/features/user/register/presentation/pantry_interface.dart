...
class PantryListInterface extends StatefulWidget {
  PantryLogic pantryLogic;
  PantryListInterface({super.key, required this.pantryLogic});

  @override
  _PantryListInterfaceState createState() => _PantryListInterfaceState();
}

class _PantryListInterfaceState extends State<PantryListInterface>
    with WidgetsBindingObserver {
  List<String> selectedStores = [];
  List<Producto> _products = [];
  final ProductoService productoService = ProductoService();
  PantryList pantryList =
      PantryList(id: '1', user: 'usuario_demo', products: []);
  ...
  Future<void> fetchAndStoreProductos() async {
    ...
    var result =
        await DatabaseOperations.instance.fetchProductsFromPantryList(db);
    setState(() {
      _products = result;
    });
  }
  ...
  Future<void> _initPantryList() async {
    PantryList fetchedLista = await widget.pantryLogic.generatePantryList();
    setState(() {
      ...
      appBar: AppBar(
        leading: IconButton(
          padding: EdgeInsets.fromLTRB(
              MediaQuery.of(context).size.shortestSide * 0.057, 0, 0, 0),
        ...
        children: [
          Padding(
            padding: EdgeInsets.symmetric(
                horizontal: MediaQuery.of(context).size.shortestSide * 0.0550),
            child: Row(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: selectedStores.contains("DIA")
                          ? Color(0xFF95B3FF)
                          : Colors.white,
                      foregroundColor: Color.fromARGB(255, 80, 79, 79),
                      side: BorderSide(
                          color: Color.fromARGB(255, 149, 179, 255), width: 2),
                    ),
                    child: Text('DIA',
                        style: TextStyle(
                            fontFamily: 'Geist',
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      shadowColor: Colors.transparent,
                      padding: EdgeInsets.zero,
                      backgroundColor: selectedStores.contains("Consum")
                          ? Color(0xFF95B3FF)
                          : Colors.white,
                      foregroundColor: Color.fromARGB(255, 80, 79, 79),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      shadowColor: Colors.transparent,
                      padding: EdgeInsets.zero,
                      backgroundColor: selectedStores.contains("Carrefour")
                          ? Color(0xFF95B3FF)
                          : Colors.white,
                      foregroundColor: Color.fromARGB(255, 80, 79, 79),
                      side: BorderSide(color: Color(0xFF95B3FF), width: 2),
            ...
            child: _isLoading
                ? Padding(
                    padding: EdgeInsets.only(
                        bottom: MediaQuery.of(context).size.longestSide * 0.17),
                    child: SizedBox(
                ...
                : _products.isEmpty
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            Image.asset('assets/images/cesta_vacia.png',
                                height:
                    ...
                    : Padding(
                        padding: EdgeInsets.fromLTRB(
                            MediaQuery.of(context).size.shortestSide * 0.0550,
                            0,
                            MediaQuery.of(context).size.shortestSide * 0.0550,
                            ...
                            return Padding(
                              ...
                              child: Dismissible(
                                  ...
                                  onDismissed: (direction) {
                                    setState(() {
                                      widget.pantryLogic
                                          .removeProduct(pantryList, producto);
                                      widget.pantryLogic
                                          .dbRemoveProductFromPantry(producto);
                                  ...
                                  background: Container(
                                      ...
                                      child: ImageIcon(
                                          AssetImage('assets/icons/basura.png'),
                                          size: MediaQuery.of(context)
                                                  .size
                                                  .shortestSide *
                                              0.0872)),
                                  child: StatefulStoreItem(
                                      producto: producto,
                                      onReturn: () =>
...
class StatefulStoreItem extends StatefulWidget {
  ...
  const StatefulStoreItem(
      {super.key, required this.producto, required this.onReturn});
...
class _ProductTileItemState extends State<StatefulStoreItem> {
  ...
  void _navigateToProductInfo(Producto producto) async {
    ListaCompra listaCompra =
        ListaCompra(id: '1', usuario: 'usuario_demo', productos: []);
    ListaFavoritos listaFavoritos =
        ListaFavoritos(id: '1', usuario: 'usuario_demo', productos: []);
  ...
  Future<void> _cargarContador() async {
    Database db = DatabaseOperations.instance.prizoDatabase;
    int count = await DatabaseOperations.instance
        .fetchAmountPantryList(db, widget.producto);
    setState(() {
      _counter = count;
    });
  }
  ...
  Future<void> _cargarBoton() async {
    Database db = DatabaseOperations.instance.prizoDatabase;
    bool boton = await DatabaseOperations.instance.existsInListaCompraTable(db, widget.producto);
    //bool boton = await pantryLogic.dbHasTickPantry(widget.producto);
    setState(() {
      _showButton = !boton;
    });
  }

  Future<void> _ventanaConfirmacion(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              onPressed: () async {
                _counter = await DatabaseOperations.instance
                    .fetchAmountPantryList(db, producto);
              ...
              child: Text('Cancelar',
                  style: TextStyle(
                      fontFamily: 'Geist',
                      fontSize:
                          MediaQuery.of(context).size.shortestSide * 0.0322,
                      fontWeight: FontWeight.w400)),
            ),
            TextButton(
              onPressed: () {
          ...
          child: GestureDetector(
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Color.fromARGB(255, 18, 18, 18),
                        fontSize:
                            MediaQuery.of(context).size.shortestSide * 0.04293,
                        fontWeight: FontWeight.w500,
                      ),
                    )),
                SizedBox(
                    height: MediaQuery.of(context).size.longestSide * 0.001),
                Text(
                ...
                SizedBox(
                    height: MediaQuery.of(context).size.shortestSide * 0.023),
                Text(
        ...
        Column(
          ...
          children: [
            _showButton
                ? IconButton(
                    padding: EdgeInsets.zero,
                    icon: Image.asset('assets/icons/empty_checkbox.png',
                        width: MediaQuery.of(context).size.shortestSide * 0.099,
                        height:
                            MediaQuery.of(context).size.shortestSide * 0.102),
                    onPressed: () async {
                      ListaCompraService listaService = ListaCompraService();
                      setState(() {
                        _showButton = false;
                      });
                      await pantryLogic.dbAddTick(widget.producto);
                      listaService.DB_annadirProducto(widget.producto);
                    })
                : IconButton(
                    padding: EdgeInsets.zero,
                    icon: Image.asset(
                    ...
                    onPressed: () async {
                      ...
                      await pantryLogic.dbTickRemove(widget.producto);
                      listaService.DB_quitarProducto(widget.producto);
                      listaService.DB_Tick_quitar(widget.producto);
                    }),
                ...
                children: [
                        ...
                        setState(() {
                          if (_counter > 0) {
                            if (_counter == 1) {
                              ...
                              pantryLogic.dbDecreaseProductAmountInPantry(
                                  widget.producto);
                            }
                            _counter--;
                          } else {
                  ...
                  Positioned(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize:
                            MediaQuery.of(context).size.shortestSide * 0.0644,
                        fontFamily: 'Geist',
                        fontWeight: FontWeight.w500,
                      ),
                    ),
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      icon: Icon(
                        Icons.add,
                        size: MediaQuery.of(context).size.shortestSide * 0.06,
                        color: Color.fromARGB(255, 18, 18, 18),
                      ),
                      onPressed: () async {
                        if (_counter < 99) {
                          await pantryLogic.dbAddProduct(widget.producto);
                          setState(() {
                            _counter++;
                          });
                        }
