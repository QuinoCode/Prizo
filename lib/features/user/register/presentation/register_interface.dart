...
import 'package:prizo/features/user/register/application/register_logic.dart';
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  PrizoText(headerNumber: 2, text: "Crea una cuenta"),
                  ...
                  SizedBox(height: height * 0.02),
                  PrizoPassTextField(
                    fieldText: "Repetir contraseña",
                    onChanged: (value){
                      _repeated_password = value;
                    },
                    onEnter: (repeatedPassword) async {
                      final (success, message) = await registerLogic.ableToRegister(_email, _password, repeatedPassword);

                      if (success) {
                        final successCreation = await registerLogic.createAccount(_email, _password);
                        if (successCreation){
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text("Account could not get created for some reason on the server side")),
                          );
                        }
                      } else {
                        // Show error message (snackbar, dialog, etc.)
