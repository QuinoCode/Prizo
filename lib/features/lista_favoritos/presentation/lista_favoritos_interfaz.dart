...
class ListaFavoritosInterfaz extends StatefulWidget {
  ...
  ListaFavoritosInterfaz({super.key, required this.listaFavoritos, required this.listaCompra, required this.original});
...
class _ListaFavoritosInterfazState extends State<ListaFavoritosInterfaz> {
  ...
  List<Producto> _filtrarProductos() {
    ...
    for (Producto producto in widget.original.productos) {
  ...
  void _toggleTienda(String tienda) {
    setState(() {
      ...
      widget.listaFavoritos = new ListaFavoritos(id: widget.original.id, usuario: widget.original.usuario, productos: _filtrarProductos());
    });
  }
